...
!
      ...
      INTEGER :: countA0, countB0, countC0, countD0, countE0, countF0, countO0, countG0
      INTEGER :: countA1, countB1, countC1, countD1, countE1, countF1, countO1, countG1
!
      ...
      REAL(sp) :: old1, old2, old3                      ! single prec. (for timing)
      REAL(sp) :: old4, old5, old6                      ! single prec. (for timing)
